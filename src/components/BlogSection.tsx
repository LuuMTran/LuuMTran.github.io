...
export function BlogSection() {
  ...
  return (
    <section id="blog" className="min-h-screen py-24 px-4 md:px-8 lg:px-16 flex items-center bg-white">
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">Latest from the Blog</h2>
